...
4. If you are using the standalone binary executable, you must include the **__internal_** folder (available at the same link: https://drive.google.com/drive/folders/1WpqFYJZdH0V00ndgPXq-H_e-maj8isea?usp=sharing). It contains the necessary libraries required to run the executable.
